...
export default function CreditCardPaymentModal({ isOpen, onClose, onSave, payment }: CreditCardPaymentModalProps) {
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            {payment ? 'Kredi Kartı Ödeme Düzenle' : 'Yeni Kredi Kartı Ödeme'}
          </DialogTitle>
        </DialogHeader>
